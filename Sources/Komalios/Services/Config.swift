...
enum Config {
    ...
    static let geminiAPIKey: String = {
        ...
        // Priority 2: Plist configuration (add GEMINI_API_KEY to Info.plist)
        if let plistKey = Bundle.main.object(forInfoDictionaryKey: "GEMINI_API_KEY") as? String, !plistKey.isEmpty {
            return plistKey
        }

        // Priority 3: Fallback to Google Cloud API key (Gemini is part of Google AI)
        // Replace with a dedicated Gemini key from https://aistudio.google.com/apikey
    ...
    static var configurationStatus: String {
        ...
        status += "✓ Gemini API Key: \(geminiAPIKey.isEmpty ? "❌ Missing" : "✅ Set")\n"
